...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="input-block">
        Nome:<asp:RequiredFieldValidator ID="rfv" runat="server" ControlToValidate="txtNome" ValidationGroup="form" ErrorMessage="Preencha o campo Nome." ForeColor="White" >*</asp:RequiredFieldValidator>
...
&nbsp;<asp:TextBox ID="txtCPF" runat="server" Height="16px" Width="189px"></asp:TextBox>
    ...
    <div class="input-block">
        Endereco:<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtEndereco" ErrorMessage="Endereço obrigatório." ValidationGroup="form" ForeColor="White">*</asp:RequiredFieldValidator>
&nbsp;&nbsp;
        <asp:TextBox ID="txtEndereco" runat="server" Width="152px"></asp:TextBox>
        <br />
    </div>
    <div class="input-block">
        Celular:<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtCelular" ErrorMessage="Celular obrigatório." ValidationGroup="form" ForeColor="White">*</asp:RequiredFieldValidator>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtCelular" ErrorMessage="Celular inválido. Ex: (xx) xxxxx-xxxx" ValidationExpression="^\([1-9]{2}\) (?:[2-8]|9[1-9])[0-9]{3}\-[0-9]{4}$" ValidationGroup="form" Visible="False" ForeColor="White">*</asp:RegularExpressionValidator>
&nbsp;&nbsp;
        <asp:TextBox ID="txtCelular" runat="server" Width="167px"></asp:TextBox>
        <br />
    </div>
    <div class="input-block">
        Data Nascimento:<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtDataNasc" ErrorMessage="Data de Nascimento obrigatória." ValidationGroup="form" ForeColor="White">*</asp:RequiredFieldValidator>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtDataNasc" ErrorMessage="Data inválida. Ex: DD.MM.YYYY" ValidationExpression="^ (d {2}). d {2}. (d {4}) $" ValidationGroup="form" Visible="False" ForeColor="White">*</asp:RegularExpressionValidator>
&nbsp;&nbsp;
        <asp:TextBox ID="txtDataNasc" runat="server" Width="100px"></asp:TextBox>
        <br />
    </div>
Personal Trainer<br />
      <asp:DropDownList ID="ddlPersonal" runat="server" DataSourceID="SqlDataSource1" DataTextField="Nome" DataValueField="ID_Personal" Height="19px" Width="154px">
      </asp:DropDownList>
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BDPegasusAcademyConnectionString %>" SelectCommand="SELECT [Nome], [ID_Personal] FROM [Personal]"></asp:SqlDataSource>
      <br />
      <br />
    <div class="input-block">
